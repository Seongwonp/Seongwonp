...
<h1 align="center">안녕하세요, 서버 엔지니어 지향 개발자 박성원입니다 👨‍💻</h1>
<p align="center">백엔드 시스템 구축과 안정적인 서버 운영에 열정을 가진 개발자입니다.</p>

---

## 📌 Portfolio & Links

* 🌐 [웹 포트폴리오](https://seongwonp-portfolio.vercel.app/)
...
* 🎓 **수원대학교 정보보호학과 편입**  
* 🏫 이전: **대구가톨릭대학교 컴퓨터공학과** 4학기 수료 (GPA: 4.1 / 4.5)  
* 🖥 **900시간 풀스택 부트캠프 수료** (공공데이터 기반)  
* 💻 **주요 기술**: Java, Spring Boot, JPA, Python, JavaScript, React, MariaDB, Docker  
* 🌱 **관심 분야**: 서버 개발, 백엔드 아키텍처, 확장 가능한 시스템 설계  
* 🤝 협업과 클린 아키텍처 중요시  
...
- 🧞‍♂️ [**CSAT_Forge – AI 기반 기출문제 생성 웹 서비스**](https://github.com/Seongwonp/CSAT_Forge) – PDF 업로드 → 문제 분석 → 맞춤 기출문제 생성 웹 서비스  
